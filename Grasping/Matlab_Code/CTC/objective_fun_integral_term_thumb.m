...
function error = objective_fun_integral_term_thumb(X, Fd, Fm, B, Jt, Kp, Ki, alpha)

      global error_integral_x_thumb error_integral_y_thumb
      integral_x = Euler(error_integral_x_thumb, (Fd(1)-Fm(1)-X(4)), 0.5);
      integral_y = Euler(error_integral_y_thumb, (Fd(2)-Fm(2)-X(5)), 0.5);
