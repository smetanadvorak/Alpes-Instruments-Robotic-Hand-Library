...
for i=1:48%<--4*8 égale à 4 fois la lecture de 8 valeurs en hexa (8 valeurs par doigt)
...
for i=1:40%<--3*8 égale à 3 fois la lecture de 8 valeurs en hexa (8 valeurs par doigt)
    fread(s,1);%<-- lecture pour ne pas interferer avec les autres lectures du principal
end
