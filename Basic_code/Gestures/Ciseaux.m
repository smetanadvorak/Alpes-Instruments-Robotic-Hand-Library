...
%
%But: faire la forme des ciseaux avec les doigts
%
...
%----------------------------CRC16 calcul------------------------------
%rotation pouce / position codeur Rpouce:16639 valeur arbitraire pour
...
%pouce / position codeur pouce:16639 valeur arbitraire pour
%ressembler a un poing fermé
...
%index
buf_index=[mot_commande,mot_commande2,Pos_mem_faible_index,Pos_mem_fort_index,Registre_faible,Registre_fort,01,00,00,00,00,00,00,00];
[crc16hi_index,crc16lo_index]=CRC16(buf_index);

%majeur
buf_majeur=[mot_commande,mot_commande2,Pos_mem_faible_majeur,Pos_mem_fort_majeur,Registre_faible,Registre_fort,01,00,00,00,00,00,00,00];
