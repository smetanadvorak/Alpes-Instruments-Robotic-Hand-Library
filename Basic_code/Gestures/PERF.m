...
buf_Rpouce=[mot_commande,mot_commande2,Pos_mem_faible_Rpouce,Pos_mem_fort_Rpouce,Registre_faible,Registre_fort,01,00,00,00,hex2dec('83'),hex2dec('3B'),00,00];
[crc16hi_Rpouce,crc16lo_Rpouce]=CRC16(buf_Rpouce);

%pouce / position codeur pouce:13832 valeur arbitraire pour
%ressembler a un poing fermé
buf_pouce=[mot_commande,mot_commande2,Pos_mem_faible_pouce,Pos_mem_fort_pouce,Registre_faible,Registre_fort,01,00,00,00,hex2dec('5A'),hex2dec('25'),00,00];
[crc16hi_pouce,crc16lo_pouce]=CRC16(buf_pouce);

%index
buf_index=[mot_commande,mot_commande2,Pos_mem_faible_index,Pos_mem_fort_index,Registre_faible,Registre_fort,01,00,00,00,hex2dec('6F'),hex2dec('53'),00,00];
[crc16hi_index,crc16lo_index]=CRC16(buf_index);

%majeur
buf_majeur=[mot_commande,mot_commande2,Pos_mem_faible_majeur,Pos_mem_fort_majeur,Registre_faible,Registre_fort,01,00,00,00,hex2dec('08'),hex2dec('22'),00,00];
[crc16hi_majeur,crc16lo_majeur]=CRC16(buf_majeur);

%annulaire
buf_annulaire=[mot_commande,mot_commande2,Pos_mem_faible_annulaire,Pos_mem_fort_annulaire,Registre_faible,Registre_fort,01,00,00,00,hex2dec('E9'),hex2dec('2B'),00,00];
[crc16hi_annulaire,crc16lo_annulaire]=CRC16(buf_annulaire);

%auriculaire
buf_auriculaire=[mot_commande,mot_commande2,Pos_mem_faible_auriculaire,Pos_mem_fort_auriculaire,Registre_faible,Registre_fort,01,00,00,00,hex2dec('4E'),hex2dec('30'),00,00];
