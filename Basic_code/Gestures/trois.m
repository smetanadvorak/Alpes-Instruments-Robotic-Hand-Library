...
%
%But: un trois avec les doigts soit le pouce l'index et le majeur levé
%
...
%------------------------choix du doigt------------------------------
%rotation pouce
    Pos_mem_faible_Rpouce=hex2dec('E8');%<--- poids faible de la première position memoire
    Pos_mem_fort_Rpouce=hex2dec('03');%<--- poids fort de la première position memoire
