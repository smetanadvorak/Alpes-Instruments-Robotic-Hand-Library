...
%
%But: lève un doigt et ferme les autres.
%
...
%pouce / position codeur pouce:19000 valeur max 
buf_pouce=[mot_commande,mot_commande2,Pos_mem_faible_pouce,Pos_mem_fort_pouce,Registre_faible,Registre_fort,01,00,00,00,hex2dec('38'),hex2dec('4A'),00,00];
