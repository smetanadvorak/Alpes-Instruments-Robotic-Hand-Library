...
%
%But: faire un quatre avec les doigts de la main
%
...
%----------------------------CRC16 calcul------------------------------
%rotation pouce 
buf_Rpouce=[mot_commande,mot_commande2,Pos_mem_faible_Rpouce,Pos_mem_fort_Rpouce,Registre_faible,Registre_fort,01,00,00,00,0,0,00,00];
[crc16hi_Rpouce,crc16lo_Rpouce]=CRC16(buf_Rpouce);

%pouce 
buf_pouce=[mot_commande,mot_commande2,Pos_mem_faible_pouce,Pos_mem_fort_pouce,Registre_faible,Registre_fort,01,00,00,00,0,0,00,00];
...
%majeur
buf_majeur=[mot_commande,mot_commande2,Pos_mem_faible_majeur,Pos_mem_fort_majeur,Registre_faible,Registre_fort,01,00,00,00,0,0,00,00];
[crc16hi_majeur,crc16lo_majeur]=CRC16(buf_majeur);

%annulaire
buf_annulaire=[mot_commande,mot_commande2,Pos_mem_faible_annulaire,Pos_mem_fort_annulaire,Registre_faible,Registre_fort,01,00,00,00,0,0,00,00];
...
for i=1:48%<--8*6 egale 6 fois la lecture de 8 valeurs en hexa (8 valeurs par doigt)
