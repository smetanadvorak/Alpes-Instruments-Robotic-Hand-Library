...
function write_LIMITE_COURANT_DEFAUT(doigt,coeff,s)
% The possible values for the current are in the interval [0,36000]
if coeff > 30000
    coeff_reel = 750;
elseif coeff < 0
    coeff_reel = 0;
...
if length(dec2hex(coeff_reel))==4
    coeff_fort3=0;
    coeff_fort2=0;
